...
def transform_Colne_N(reach,area,land_space_elements,Discharge,Abstraction):
    ...
    while i < len(df):
        if not tr01_found and reach in df.iloc[i].values:
            ...
            try:
                ...
                line_values = line_to_update_line_space_elements.str.split(' ')
                line_values[0][2] = Discharge
                line_values[0][3] = Abstraction
        ...
        i += 1 
    par_file_path = 'Colne_INCA-N.par'
