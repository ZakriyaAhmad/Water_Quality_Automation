...
def run_queries(use_case,user_id):
    ...
    f"""INSERT INTO "AquaScope_MVP".inca_p_output_dsd_user_scenerio(
    ...
    """ALTER TABLE "AquaScope_MVP".inca_p_output_dsd_user_scenerio Drop COLUMN id""",
    """ALTER TABLE "AquaScope_MVP".inca_p_output_dsd_user_scenerio ADD COLUMN id SERIAL PRIMARY KEY""",
    # "-- insert colne data into table",
    f"""INSERT INTO "AquaScope_MVP".inca_n_output_dsd_user_scenerio(
    ...
    """ALTER TABLE "AquaScope_MVP".inca_n_output_dsd_user_scenerio Drop COLUMN id""",
    """ALTER TABLE "AquaScope_MVP".inca_n_output_dsd_user_scenerio ADD COLUMN id SERIAL PRIMARY KEY"""]
